    ...
    <>
      <div className='fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-sm shadow-[0_-8px_30px_rgba(0,0,0,0.08)] p-2 h-16 flex justify-around z-40'>
        ...
        <button
          ...
          className={`flex items-center justify-center ${isActive("/orders") ? "text-[#9D5623]" : "text-[#ababab]"
            } w-[300px] rounded-[20px] cursor-pointer`}>
          <MdOutlineReorder className="inline mr-2" size={20} /><p>Orders</p>
        </button>
        <button
          onClick={() => navigate("/tables")}
          className={`flex items-center justify-center ${isActive("/tables") ? "text-[#9D5623]" : "text-[#ababab]"
            } w-[300px] rounded-[20px] cursor-pointer`}>
